(function() {
    ...
    var sa = -1 != l.indexOf("Opera") || -1 != l.indexOf("OPR"),
        ...
        ta = -1 != l.indexOf("Gecko") && -1 == l.toLowerCase().indexOf("webkit") && !(-1 != l.indexOf("Trident") || -1 != l.indexOf("MSIE")),
        ...
        wa = function() {
            ...
            ta ? b = /rv\:([^\);]+)(\)|;)/ : m ? b = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : ua && (b = /WebKit\/(\S+)/);
            b && (a = (a = b.exec(l)) ? a[1] : "");
        ...
        n = function(a) {
            ...
            if (!(b = xa[a])) {
                b = 0;
                for (var c = ka(String(wa)).split("."), d = ka(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                    var g = c[f] || "",
                        h = d[f] || "",
                        k = RegExp("(\\d*)(\\D*)", "g"),
                        t = RegExp("(\\d*)(\\D*)", "g");
                    do {
                        ...
                        b = la(0 == q[1].length ? 0 : parseInt(q[1], 10), 0 == D[1].length ? 0 : parseInt(D[1], 10)) || la(0 == q[2].length,
                            0 == D[2].length) || la(q[2], D[2])
                    } while (0 == b)
                }
                b = xa[a] = 0 <= b
            }
    ...
    var Ca = function(a) {
            ...
            Ba[c] = b; - 1 != a.search("&ei=") || (d = "&ei=");
            a = "/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + ha();
            /^http:/i.test(a) && "https:" == window.location.protocol ? delete Ba[c] : (b.src = a, Aa = c + 1)
        },
        Ba = [],
        Aa = 0;
    var Da, Ea = 0 <= navigator.userAgent.indexOf("MSIE"),
        Ga = function(a) {
            for (var b = Fa, c = 0; c < b.length; c++)
                if (a === b[c]) return !0;
            return !1
        },
        Ia = function() {
        ...
        La = function() {
            ...
            window.WebFontConfig || (ia("WebFontConfig.google.families", a), a = document.createElement("script"), a.src = ("https:" == document.location.protocol ? "https" : "http") + "://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js", a.type = "text/javascript", a.async = "true", (document.getElementById("xjsc") || document.body).appendChild(a))
        },
        Ma = function(a, b) {
            var c = a / b;
        ...
        Oa = function(a) {
            if (window.google &&
                window.google.log) {
                var b;
                Da || (b = document.getElementById("hplogoved")) && (Da = b.getAttribute("data-ved"));
                (b = Da) && (a += "&ved=" + b);
    ...
    Wa.prototype.v = function() {
        ...
        var a = v(this),
            b = w(this);
        if (!a || !b) return !1;
        var c = this.A ? .2071 * Math.max(a, b) : 0,
        ...
        var f = (0 > this.k ? -a : a) / 2,
            ...
            e = this.x + f - d * f + c * g,
            f = this.y + g - d * g - c * f;
        this.F && (e += this.F * (Math.random() - .5), f += this.F * (Math.random() - .5));
        0 > this.k && (e += a);
        0 > this.o && (f += b);
        var g = this.U / b,
            h = this.V / a;
        this.B.transform(this.k * (d - h * c), this.k * (h * d + c), this.o * (g * d - c), this.o * (d + g * c), e, f);
        try {
            if (this.H || this.D)
                for (var k = Math.abs(this.p * this.k), t = Math.abs(this.s * this.o), q = Math.ceil(a / k), D = Math.ceil(b / t), fa = Ma(a, k) || k, ab = Ma(b, t) || t, a = 0; a < D; a++)
                    for (b = 0; b < q; b++) Ya(this, b * this.p, a * this.s,
                        b == q - 1 ? fa : this.p, a == D - 1 ? ab : this.s);
    ...
    var $a = function(a, b, c) {
        ...
        Ya = function(a, b, c, d, e) {
            ...
            d = d - a.la - a.W;
            e = e - a.ka - a.X;
            0 > d || 0 > e || a.B.drawImage(a.w, f + a.frame * a.p, g, d, e, a.W + a.R + b, a.X + a.S + c, d, e)
        };
    var bb = {},
        cb = {
            ra: 0,
    ...
    var db = [],
        ...
        ib = function() {
            ...
            hb && (window.requestAnimationFrame ? window.requestAnimationFrame(ib) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(ib) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(ib) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(ib) : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(ib))
        },
        lb = function(a) {
            fb = A;
            gb = a || null;
            window.addEventListener && (window.addEventListener("MozGamepadConnected", jb, !1), window.addEventListener("MozGamepadDisconnected",
                kb, !1));
            ...
            if (google) {
                var d = function() {
                    ...
                    e = function() {
                        ...
                        a && "hidden" != a.style.visibility && (a = google.msg && google.msg.listen, google.na && google.na.q && a && (a(106, d), c && a(94, c)))
                    };
                e();
                google.doodle && google.doodle.jesr || (ia("google.doodle.jesr", !0), google.raas && google.raas("doodle", {
                    init: function() {
                        e();
    ...
    var tb = function(a, b, c, d, e, f, g, h, k, t, q) {
        if (a.o) {
            var D = a.i[b],
                ...
                fa = g * fa,
                Eb = q || !1;
            c.drawImage(a.k.i, D[0] + d, D[1] + e, f, g, h - (Eb ? ab / 2 : 0), k - (Eb ? fa / 2 : 0), ab, fa)
        } else sb(a, function() {
    ...
    var Fb = function(a) {
        ...
        Hb = function(a, b, c, d, e) {
            ...
            b = a.i[f];
            b || (b = a.i[f] = [], a.k++);
            var g = Gb(b, c, d, e); - 1 < g ? (a = b[g], a.O = !1) : (a = new Cb(c, a.src, f, !!d, e), a.O = !1, b.push(a));
            return a
        },
        Ib = function(a, b) {
            var c = b.type;
    ...
    var Kb = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Nb = function(a, b, c, d, e) {
            ...
            if (a && a[Ab]) a = a.listen(b, c, d, e);
                ...
                g || (a[Kb] = g = new Fb(a));
                c = Hb(g, b, c, d, e);
                c.i || (d = Qb(), c.i = d, d.src = a, d.I = c, a.addEventListener ? a.addEventListener(b.toString(), d, f) : a.attachEvent(Rb(b.toString()), d), Mb++);
                a = c
            }
            return a
        },
        ...
        Tb = function(a, b, c, d, e) {
            ...
            else c = Ob(c), a && a[Ab] ? a.unlisten(b, c, d, e) : a && (a = Pb(a)) && (b = Jb(a, b, c, !!d, e)) && Ub(b)
        },
        Ub = function(a) {
            ...
            var c = a.type,
                d = a.i;
            b.removeEventListener ? b.removeEventListener(c, d, a.N) : b.detachEvent && b.detachEvent(Rb(c), d);
            Mb--;
        ...
        Sb = function(a, b) {
            ...
            if (!wb) {
                ...
                if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                    ...
                    for (h = 0; !c.o && h < e.length; h++) c.k = e[h],
                    k = Wb(e[h], f, !1, c),
                    d = d && k
                }
                return d
    ...
    var Zb = function(a, b) {
        ...
        if (c)
            for (k = 0; !e.o && k < c.length; k++) h = e.k = c[k], g = Yb(h, f, !1, e) && g;
        return g
    };
    ...
    E.prototype.unlisten = function(a, b, c, d) {
        ...
        if (a in e.i) {
            var f = e.i[a];
            b = Gb(f, b, c, d); - 1 < b ? (Db(f[b]), ma.splice.call(f, b, 1), 0 == f.length && (delete e.i[a], e.k--), e = !0) : e = !1
        } else e = !1;
        return e
    };
    ...
    F.prototype.unlisten = function(a, b, c, d, e) {
        ...
        else c = c || this.handleEvent, e = e || this.B || this, c = Ob(c), d = !!d, b = a && a[Ab] ? Jb(a.G, String(b), c, d, e) : a ? (a = Pb(a)) ? Jb(a, b, c, d, e) : null : null, b && (Ub(b), delete this.s[b.ha]);
        return this
    };
    ...
    var fc = function(a, b, c, d, e) {
        ...
        this.F = c;
        this.C = d;
        e && (this.p && this.unlisten(this.p, "action", this.w), e && (this.p = new ac(e), a = ga(zb, this.p), this.o ? a.call(void 0) : (this.k || (this.k = []), this.k.push(a)), this.w = ea(this.H, this), this.listen(this.p, "action", this.w)))
    };
    ja(fc, F);
    fc.prototype.H = function() {
        gc() && -1 == l.indexOf("Trident") && -1 == l.indexOf("MSIE") && window.gapi && window.gapi.load ? (window.gapi.load("share", ea(this.A, this)), Oa("gplus,li")) : (window.open("https://plus.google.com/share?url=" + this.D), Oa("gplus,lo"))
    };
    var gc = function() {
    ...
    var hc, ic, A, jc, kc, lc, G, mc, nc, oc, pc, qc, rc, sc, tc, uc, vc, wc, xc, H, yc, zc, Ac, I, Bc, J, Fa = [32, 13],
        Cc = [],
        Dc = 0,
        Ec = !1,
        Fc = 0,
        ...
        Tc = function() {
            var a = Nc,
                ...
                c = Oc(2) + " \u2014 " + Oc(0) + ": ";
            kc = "soccer";
            var d = window.location.protocol + "//www.google.com/doodles/soccer-2012";
            Pc("olympics12-hp-sprite.png");
            I = p("div", "hplogo_sc");
            ic = p("div", "hplogo_sb");
        ...
        Xc = function() {
            ...
            if (!A) return !1;
            google.doodle && google.doodle.alt && A.setAttribute("aria-label", google.doodle.alt);
            A.innerHTML = "";
            return !0
        },
        Pc = function(a) {
            var b =
                p("img");
            b.src = "http://www.google.com/logos/2012/" + a;
            rc && (b.complete || "complete" == b.readyState ? sc || (sc = window.setTimeout(Yc, 10)) : (b.onload = Zc, Dc++));
            return b
        },
        K = function() {
            var a = ha(),
            ...
            b = Math.min(40, b);
            yc || oc && 18E4 < a - oc ? Ec = !1 : !Hc && jc(a, b) ? (window.requestAnimationFrame ? window.requestAnimationFrame(K, A) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(K) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(K) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(K) :
                window.webkitRequestAnimationFrame ? window.webkitRequestAnimationFrame(K, A) : window.setTimeout(K, 16), nc = a, Ec = !0) : Ec = !1
        },
        Sc = function(a, b, c) {
            window.google && window.google.log && window.google.log("doodle-soccer", "p:" + a + ",s:" + ("undefined" != typeof b ? b : "_") + ",nc:" + ("undefined" != typeof c ? c : "_") + ",d:" + Fc + ",")
        },
        Uc = function(a, b) {
            return function() {
                a.className = b
        ...
        ad = function(a) {
            $c();
            (37 == a.keyCode || 39 == a.keyCode || 38 == a.keyCode || 40 == a.keyCode || Ga(a.keyCode)) && a.preventDefault();
    ...
    var hd, L, M, id, jd, kd, N, ld, md, nd, od, pd, qd, Ha, rd, O, P, sd, Q, R, td, ud, vd, wd, xd, yd, zd, Ad, S, T, Bd = function(a, b, c, d, e) {
        this.k = d;
        this.s = e;
        this.k.i = 0;
        this.height = c;
    ...
    var Dd, Ed, Fd, Gd, Hd, Id, U, Jd, Sa, Ld = function() {
        ...
        Kd = function() {
            for (var a = [], b = 0, c; c = jd[b++];) 0 == c.state &&
                a.push(c);
            Id = a.length ? a[Math.floor(Math.random() * a.length)] : null;
            null != Id && (a = Id.x, Gd = Dd, Hd = a, Ed.play())
        };
    var W, Md, Nd, Od, Pd, Qd, Rd, Sd, Td, Ud, Vd, X, Wd, Y, Xd, $d = function() {
        ...
        ae = function() {
            W.x = X - v(W) / 2;
            W.y = Wd;
            var a = 30 + 30 * (Math.cos(3.14 * (.5 + (1 + Nd.frame) / 18)) + 1);
            Cd(X, Wd, a, .3 * a, "rgba(0,0,0,0.2)");
            W.v()
        },
        be = function() {
            null == Y && (2 == L ? (W = Pd, Y = Od) : 5 == L ? 0 < M ? (W = Td, Y = Sd) : (W = Vd, Y = Ud) : Xd ? (W = Nd, Y = Md) : N[2] && 150 <= X ? (W = Pd, Y = Od) : (N[2] && 150 <= X ? 0 : N[3] && 390 >= X) ? (W = Rd, Y = Qd) : (W = Pd, W.frame = 0), Y && Y.play())
        };
    var ce = {
    ...
    var Z = [],
        ...
        Vc = function(a, b) {
            ...
            1 == ud && ld && md && fe(2);
            yd += b;
            4 == L && 2E3 < yd && 3 > id && (yd = 0, Id ? (U = Jd, Sa.play()) : Kd());
            N[2] && 150 <= X ? X -= 5 : (N[2] && 150 <= X ? 0 : N[3] && 390 >= X) && (X += 5);
            be();
            for (var d = X, e = 0,
                    f; f = jd[e++];) {
                var g = f,
                    h = c;
                g.k.i = Math.min(1, g.k.i + .001 * h);
                g.k.i = 1;
                g.height += g.i * h;
                var k = .2;
                2 == g.state && (k = .015 * Math.sqrt(Math.abs(g.p - g.y) + Math.abs(g.o - g.x)));
                var t = h * k,
                ...
                g.x += k;
                g.y += t;
                0 > g.height ? (g.height = 0, g.i = .1 > Math.abs(g.i) ? 0 : g.i = .6 * -g.i) : 0 < g.height && (g.i -= g.w * h);
                2 == f.state && 50 >= f.y && (f.state = 0);
                1 == f.state && 191 <= f.y && (w(f.k), 50 < Math.abs(f.x -
                    d) || f.A && !Xd || !f.A && Xd ? (f.state = 3, id++) : (f.state = 2, M++, f.o = 200 + 200 * Math.random(), f.p = 50, f.i = 0))
            }
            3 <= id && ee(5);
            ge(a);
            return !0
        ...
        Cd = function(a, b, c, d, e) {
            ...
            f.translate(a, b);
            f.scale(c, d);
            f.arc(.5, .5, .5, 0, 2 * Math.PI, !0);
            f.fillStyle = e;
            f.fill();
            f.restore()
        },
        ke = function(a) {
            return 37 == a.keyCode ? 2 : 39 == a.keyCode ? 3 : 38 == a.keyCode ||
                Ga(a.keyCode) ? 1 : 0
        },
        le = function(a) {
            2 != Fc && (Fc = 0);
        ...
        Wc = function() {
            ...
            qc = le;
            A.onkeydown = ad;
            A.style.cursor = "pointer"; - 1 != navigator.userAgent.indexOf("Opera") && (A.onkeypress = bd);
            ee(1);
            K()
        },
        ne = function() {
        ...
        oe = function(a) {
            if (null != Ha) {
                if (a = a || window.event) {
                    ...
                    a = b && void 0 !== b.pageX ? [b.pageX, b.pageY] : void 0 !== a.clientX ? [a.clientX + ("rtl" == document.dir ? -1 : 1) * (document.body.scrollLeft || document.documentElement.scrollLeft || 0), a.clientY + (document.body.scrollTop || document.documentElement.scrollTop || 0)] : void 0 !== a.pageX ? [a.pageX, a.pageY] : [0, 0]
                } else a = [0, 0];
                var b = Ha,
                    c = 0;
                if (b) {
                ...
                a = a[0] - c;
                3 == L && (null == nd ? nd = a : 75 < Math.abs(nd - a) && (ld = md = !0));
    ...
    (function(a, b, c) {
        ...
        hd = id = M = 0;
        if (Xc()) {
            zd = Pc("soccer12-hp-sprite.png");
            Ad = new rb("http://www.google.com/logos/2012/soccer12-hp-sprite.png", gd);
            Ha = Ic();
            kd = Ha.getContext("2d");
            wd = Mc();
            Tc();
            ...
            od = new Wa(Ha, Pc("soccer12-hp-bg.png"));
            pd = V(4);
            qd = V(3);
            vd = new r;
            u(vd, function() {
